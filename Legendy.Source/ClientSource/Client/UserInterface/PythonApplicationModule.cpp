...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXTRA_APPLY_BONUS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTRA_APPLY_BONUS", 0);
#endif

#ifdef ENABLE_ELEMENTAL_APPLY_BONUS
	PyModule_AddIntConstant(poModule, "ENABLE_ELEMENTAL_APPLY_BONUS", 1);
#else
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DROP_DIALOG_EXTENDED_SYSTEM", 1);
#else
